...
public class InstructionsForlvl2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Doorlvl2.activeSelf)
        {
            light.transform.LookAt(Doorlvl2.transform.position);
        }
    }
